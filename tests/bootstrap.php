<?php
/**
 * WooCommerce_Category_Sorting Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_woocommerce_category_sorting_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/woocommerce-category-sorting.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_woocommerce_category_sorting_plugin' );
